...
void ABlasterCharacter::MulticastElim_Implementation()
{
	...
	if (DissolveMaterialInstance) 
	{
		...
		DynamicDissolveMaterialInstance->SetScalarParameterValue(TEXT("Glow"), 15.f);
	}
	StartDissolve();
...
void ABlasterCharacter::CalculateAO_Pitch()
{
	...
	{
		//[270,360)->[-90,0)
		//UnrealEngine compresses pitch angle into 180~360 for better network performance, while our project animation uses -90~90 
